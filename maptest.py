...
# breath first search
    ...
    adj_list = {
        ...
        'minuf': ['el shohada', 'shebin', 'el-bagour', 'ashmun',
                  'el sadat city'],
        'tala': [
            'birket as sab',
            'shebin',
        ...
        'birket as sab': ['tala', 'shebin', 'quwaysna', 'As Santah',
                          'zefta'],
        'el-bagour': [
            'quwaysna',
            'shebin',
        ...
        'ashmun': ['el-bagour', 'minuf', 'el sadat city',
                   'Al Qanatir Al Khayriyyah', 'toukh'],
        'quwaysna': [
            'birket as sab',
            'shebin',
            'el-bagour',
        ...
        'El-Mahalla El-Kubra': ['qutur', 'tanta', 'As Santah', 'zefta',
                                'Samannoud'],
        ...
        'As Santah': ['Samannoud', 'El-Mahalla El-Kubra',
                      'birket as sab', 'tanta'],
        'tanta': [
            'tala',
            'Kafr El-Zayat',
        ...
        'banha': ['kafr shokr', 'quwaysna', 'el-bagour', 'toukh',
                  'shibin el qanatir'],
        'toukh': [
            'banha',
            'el-bagour',
        ...
        'Al Qanatir Al Khayriyyah': ['toukh', 'ashmun',
                'Shubra Al Khaymah', 'qalyub'],
        'Shubra Al Khaymah': ['Al Qanatir Al Khayriyyah', 'qalyub',
                              'el khankah'],
        'qalyub': ['el khankah', 'shibin el qanatir', 'toukh',
                   'Al Qanatir Al Khayriyyah', 'Shubra Al Khaymah'],
        'shibin el qanatir': ['banha', 'toukh', 'qalyub', 'el khankah'
                              ],
        'el khankah': ['shibin el qanatir', 'qalyub',
                       'Shubra Al Khaymah'],
        }
...
# A* Algorithm
    ...
    if __name__ == '__main__':
        cities = {
            ...
            'el-bagour': {
                ...
                'banha': 26.6,
                'toukh': 39.7,
                'Al Qanatir Al Khayriyyah': 30.8,
                },
            'ashmun': {
                'el-bagour': 23.8,
                'minuf': 27.1,
                'el sadat city': 61.7,
                'Al Qanatir Al Khayriyyah': 23.5,
                'toukh': 56.3,
                },
            'quwaysna': {
                'birket as sab': 13.9,
            ...
            'el shohada': {'tala': 14.4, 'shebin': 17.5,
                           'minuf': 18.2},
            'Kafr El-Zayat': {'basioun': 20.2, 'tanta': 27.6,
                              'tala': 25.6},
            'basioun': {'qutur': 16.8, 'tanta': 28.8,
                        'Kafr El-Zayat': 20.2},
            'qutur': {'basioun': 17.1, 'tanta': 16.3,
                      'El-Mahalla El-Kubra': 28.8},
            'El-Mahalla El-Kubra': {
                'qutur': 30.8,
                'tanta': 31.5,
                'As Santah': 30.8,
            ...
            'Samannoud': {'El-Mahalla El-Kubra': 7.8,
                          'As Santah': 46.6, 'zefta': 33.1},
            'zefta': {
                'Samannoud': 35,
                'El-Mahalla El-Kubra': 32.7,
                'As Santah': 17.9,
                'quwaysna': 21.1,
                'birket as sab': 25.3,
                'kafr shokr': 27.9,
            ...
            'tanta': {
                ...
                'basioun': 28.3,
                'qutur': 16,
                'El-Mahalla El-Kubra': 29.2,
                'As Santah': 25.9,
                },
            'kafr shokr': {'zefta': 32.7, 'quwaysna': 23.1,
                           'banha': 13.4},
            'banha': {
                'kafr shokr': 17.7,
                'quwaysna': 17.8,
            ...
            'toukh': {
                ...
                'el-bagour': 40,
                'ashmun': 57.5,
                'Al Qanatir Al Khayriyyah': 25,
                'qalyub': 22,
                'shibin el qanatir': 14,
                },
            'Al Qanatir Al Khayriyyah': {
                'toukh': 24.7,
                'ashmun': 23.5,
                'Shubra Al Khaymah': 18.5,
                'qalyub': 7.6,
                },
            'Shubra Al Khaymah': {'Al Qanatir Al Khayriyyah': 18.4,
                                  'qalyub': 11.6, 'el khankah': 22.4},
            'qalyub': {
                'el khankah': 26.9,
                'shibin el qanatir': 20.6,
                'toukh': 22.7,
                'Al Qanatir Al Khayriyyah': 7.6,
                'Shubra Al Khaymah': 12.1,
                },
            'shibin el qanatir': {
                'banha': 29.8,
                'toukh': 14,
            ...
            'el khankah': {'shibin el qanatir': 15.9, 'qalyub': 27.4,
                           'Shubra Al Khaymah': 24.4},
            }
...
elif Algo == 'D Algo' and startP != endP:
    ...
    def dijkstra(start, end):
            ...
            def construct_graph(self, nodes, init_graph):
                ...
                for (node, edges) in graph.items():
                    for (adjacent_node, value) in edges.items():
                        if graph[adjacent_node].get(node, False) \
                            == False:
        ...
        path = print_result(previous_nodes, startP, endP)
        return path


    final_list = dijkstra(startP, endP)
else:

    print ('The start can not equal the end !')
...
Coordinates = {  # el menofia
    ...
    'Al Qanatir Al Khayriyyah': [30.194609758641715,
                                 31.13391214967144],
